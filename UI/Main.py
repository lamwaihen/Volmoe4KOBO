...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_4.addWidget(self.buttonSelectFile)
        ...
        self.editTOC = QtWidgets.QPlainTextEdit(self.pageTOC)
        self.editTOC.setObjectName("editTOC")
        self.gridLayout_4.addWidget(self.editTOC, 0, 1, 1, 1)
        ...
        self.progressBar = QtWidgets.QProgressBar(self.pageProcess)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "選取書本打開後的第一頁。"))
        self.label_12.setText(_translate("MainWindow", "頁碼："))
        ...
        self.label_13.setText(_translate("MainWindow", "頁數："))
